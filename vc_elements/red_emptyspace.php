...
class WPBakeryShortCode_red_emptyspace extends WPBakeryShortCode
{
    ...
    function emptyspace_css_render(){ 
        echo '<div class="red-inline-css" data-css="'.$this->css.'"></div>';
    }
    ...
    public function emptyspace_css() {
        ...
        foreach($values as $value){
            $screen_size_min = isset($value['screen_size_min']) ? $value['screen_size_min'] : '0';
