...
if(!function_exists('alacarte_header_wishlist')){
	...
	?>
		<a href="<?php echo WPcleverWoosw::get_url();?>" class="red-header-wishlist-icon header-icon has-badge"><span class="<?php echo esc_attr($args['icon']); ?>"></span><span class="header-count wishlist-count" data-count="0"><?php echo WPcleverWoosw::get_count();?></span></a>
	<?php
